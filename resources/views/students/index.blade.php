<x-app-layout>
                    ...
                    <form method="GET" action="{{ route('students.index') }}" class="space-y-4">
                        <div class="flex flex-col lg:flex-row gap-4">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <select name="status"
                                    class="px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">
                                ...
                                <select id="section_filter" name="section_id"
                                    class="px-4 py-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed"
                                    {{ request('academic_period_id') ? '' : 'disabled' }}>
                                    <option value="">Todas las secciones</option>
                                </select>

                                <button type="submit"
                                    class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-semibold rounded-xl shadow-lg shadow-emerald-500/25 hover:shadow-emerald-500/40 transition-all duration-300">
                            ...
                            @forelse ($students as $student)
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-lg flex items-center justify-center text-white font-semibold text-sm shadow-md">
                                    ...
                                    <td class="px-6 py-4">
                                        <span
                                            class="font-mono text-sm text-gray-600 dark:text-gray-300">{{ $student->student_code }}</span>
                                    </td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        @if ($student->is_active)
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300">
                                                ...
                                                <ul class="py-1 text-sm">
                                                    ...
                                                    <li>
                                                        <button type="button"
                                                            ...
                                                            class="flex items-center gap-2 w-full text-left px-4 py-2 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">
                                                            <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                                viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    stroke-width="2"
                                                    ...
                                                    @if ($student->is_active && $hasActiveEnrollments)
                                                        <li class="border-t border-gray-200 dark:border-gray-600">
                                                            <a href="{{ route('students.withdraw.form', $student) }}"
                                                                class="flex items-center gap-2 px-4 py-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/30">
                                ...
                                <div id="situationModal-{{ $student->id }}"
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-lg font-bold mb-2 text-gray-900 dark:text-white">Cambiar
                                            Situación</h3>
    ...
    <div id="floating-dropdown"
        class="hidden fixed bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50 min-w-[180px]">
    </div>
