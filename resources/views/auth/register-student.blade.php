                    ...
                    <form method="POST" action="{{ route('register-client') }}">
                        ...
                        <div class="flex flex-wrap -mx-2 mb-4">
                            ...
                            <div class="w-full sm:w-1/3 px-2 mb-4">
                                ...
                                <x-text-input id="representative_name" class="block mt-1 w-full uppercase cursor-not-allowed" :value="$representative->user->name" disabled />
                            </div>

                            <div class="w-full sm:w-1/3 px-2 mb-4">
                                <x-input-label for="representative_last_name" :value="__('Apellidos del representante')" />
                                <x-text-input id="representative_last_name" class="block mt-1 w-full uppercase cursor-not-allowed" :value="$representative->user->last_name" disabled />
                            </div>

                            <div class="w-full sm:w-1/3 px-2 mb-4">
                                <x-input-label for="representative_document_id" :value="__('DNI/NIE del representante')" />
                                <x-text-input id="representative_document_id" class="block mt-1 w-full uppercase cursor-not-allowed" :value="$representative->document_id" disabled />
                            </div>
                            ...
                            <div class="w-full sm:w-1/3 px-2 mb-4">
                                ...
                                <x-text-input id="email" class="block mt-1 w-full lowercase" type="email" name="email" :value="old('email')" autocomplete="off" />
