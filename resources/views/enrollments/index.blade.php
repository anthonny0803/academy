<x-app-layout>
                                ...
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-500 rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-md">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm text-gray-600 dark:text-gray-400">{{ $enrollment->section->academicPeriod->name }}</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm text-gray-600 dark:text-gray-400">{{ $enrollment->created_at->format('d/m/Y') }}</span>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="7" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 dark:text-gray-400">No se encontraron inscripciones
                                            </p>
                                        </div>
                                    </td>
                                </tr>
    ...
    <div id="deleteModal"
        ...
        <div
            class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md my-8 border-t-4 border-red-500 overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="p-4 bg-red-50 dark:bg-red-900/20 rounded-xl mb-4">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">Sección: <span
                            id="delete-section-name"></span></p>
                </div>
                <p class="text-sm text-red-600 dark:text-red-400">
                    <strong>Advertencia:</strong> Esta acción no se puede deshacer y se perderán todas las
