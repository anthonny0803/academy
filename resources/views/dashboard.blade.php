                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @role('SuperAdmin|Administrador')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <a href="{{ route('register-client') }}" class="block p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
